    ...
    return (
        <div id="Container">
            <form className="form">
                ...
                <input className="form-content" type="text" placeholder="Enter Task" value={inputText} onChange={(e) => setInputText(e.target.value)} />
                <button onClick={(e) => {
                    e.preventDefault();
                    handleAddTodo();
                }}>Add</button>
                ...
                <div className="form-footer">Copyright @ammarsaa 2023</div>
            </form>
            <div id="rays">
                <svg
                    fill="none"
